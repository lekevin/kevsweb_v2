const About = () => {
  return (
    <div
      id="about"
      className="min-h-screen min-w-screen bg-customBlack flex flex-col text-zinc-600 tracking-wider font-normal items-center"
    >
      ...
      <div className=" w-[65vw]">
        <div className="flex flex-row pb-4 items-end gap-1 sm:gap-2">
          <div className="text-3xl font-medium">Experience<span className="text-white font-semibold">.</span></div>
        ...
        <div className="flex flex-col items-start">
          <div className="text-3xl font-medium pt-20">Education<span className="text-white font-semibold">.</span></div>
          <div className="text-lg tracking-widest text-white opacity-80">
            Wichita State University | Bachelor of Arts - Computer Science | Minor -
            Mathematics
          </div>
        </div>
